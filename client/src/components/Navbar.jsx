...
export default function Navbar() {
    ...
    return (
        <>
            <nav className={`fixed top-0 left-0 w-full h-[64px] z-50 flex items-center justify-between px-5 ${scrolled ? 'bg-[rgba(240,235,225,0.95)] backdrop-blur-[20px] saturate-[180%] border-b border-[rgba(200,169,110,0.15)] transition-all duration-[350ms] ease-out' : 'backdrop-blur-[8px] transition-all duration-[350ms] ease-out'}`} style={scrolled ? {} : { backgroundColor: 'var(--navbar-bg)' }}>
                <motion.div
                ...
                >
                    ...
                    <a href="https://wa.me/212649668465" target="_blank" rel="noreferrer" className="text-gold cursor-pointer">
